import{_ as e,o as n,c as i,d as s}from"./app.e2427bec.js";const a={},d=s(`<h1 id="sysenv" tabindex="-1"><a class="header-anchor" href="#sysenv" aria-hidden="true">#</a> sysenv</h1><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>View the current JVM environment variables.</p></div><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code> USAGE:
   sysenv [-h] [env-name]
...
USER=admin
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,9),l=[d];function v(r,c){return n(),i("div",null,l)}const t=e(a,[["render",v],["__file","sysenv.html.vue"]]);export{t as default};
