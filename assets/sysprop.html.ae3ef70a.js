import{_ as e,o as n,c as i,d as a}from"./app.e2427bec.js";const s={},r=a(`<h1 id="sysprop" tabindex="-1"><a class="header-anchor" href="#sysprop" aria-hidden="true">#</a> sysprop</h1><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Examine the system properties from the target JVM</p></div><h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code> USAGE:
...
user.country=CN
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11),l=[r];function d(v,c){return n(),i("div",null,l)}const o=e(s,[["render",d],["__file","sysprop.html.vue"]]);export{o as default};
